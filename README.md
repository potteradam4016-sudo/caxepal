...
현재 저장소에는 **React 프론트엔드와 PC 디자인 프로토타입**이 있습니다. 최신 계정 정책과 화면 동작은 React 구현과 [기능 범위](docs/product-scope.md)를 기준으로 합니다. FastAPI 서비스와 배포는 아직 구현되지 않았습니다.
...
프론트엔드는 React 구현과 최신 명세를 기준으로 개발합니다. 기존 PC 프로토타입은 시각 참고용 레거시 자료이며, 백엔드는 기획서를 기준으로 설계·개발합니다.
